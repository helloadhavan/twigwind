...
---██║---╚███╔███╔╝██║╚██████╔╝╚███╔███╔╝██║██║-╚████║██████╔╝
---╚═╝----╚══╝╚══╝-╚═╝-╚═════╝--╚══╝╚══╝-╚═╝╚═╝--╚═══╝╚═════╝-`);
    console.log(color.green("🔨 Twigwind: Compressing CSS files in ./dist ..."));
    const compressPath = path.join(__dirname, "compress.js");
    if (!fs.existsSync(compressPath)) {
      console.error(color.red("❌ compress.js not found! Make sure you're in the Twigwind package folder."));
      process.exit(1);
    }
    execSync(`node "${compressPath}"`, { stdio: "inherit" });
    break;
...
Usage:
  ...
  ${color.blue("twigwind compress")}  Compress CSS files in ./dist
  ${color.blue("twigwind help")}      Show this help message
